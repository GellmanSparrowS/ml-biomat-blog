...
SITE = {
    ...
    "description_en": "Tutorials, research notes, and practical guides on ML and multiscale modeling for fiber-based biomaterials. Home of FiberNet, a Python toolkit for fiber network design and optimization.",
    "description_zh": "纤维生物·材料·结构的机器学习与多尺度模拟教程、研究笔记和实战指南。FiberNet 纤维网络设计 Python 工具包的官方网站。",
    "author": "Yunhao Yang",
